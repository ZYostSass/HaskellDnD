...
/* package HaskellDnD-0.1.0.0 */
#ifndef VERSION_HaskellDnD
#define VERSION_HaskellDnD "0.1.0.0"
#endif /* VERSION_HaskellDnD */
#ifndef MIN_VERSION_HaskellDnD
#define MIN_VERSION_HaskellDnD(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellDnD */
/* package HaskellDnD-0.1.0.0 */
#ifndef VERSION_HaskellDnD
#define VERSION_HaskellDnD "0.1.0.0"
#endif /* VERSION_HaskellDnD */
...
#define CURRENT_COMPONENT_ID "HaskellDnD-0.1.0.0-9qvQdZH9UNn8sHRulYWgDU-HaskellDnD-exe"
